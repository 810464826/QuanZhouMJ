package com.uitrs.web.common.controller;
	...
	public void config() {
		...
		for (Class controller : controllerClasses) {
			...
			if (controllerPath == null) {
				...
				logger.info("routes.add(" + controllerKey(controller) + ", " + controller.getName() + "," + baseWebPath
						+ ")");
				...
				logger.info("routes.add(" + controllerPath.controllerKey() + ", " + controller + "," + baseWebPath
